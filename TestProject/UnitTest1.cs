...
{
    /// <summary>
    /// Para executar o teste, bot�o direito encima do teste e clique em "Executar e Testar" ou em "Teste de Deupra��o"
    /// </summary>
    public class Tests
    {
        Logica logica;
        ...
        public void ConverteStringParaInt()
        {
            ...
            int numeroDecimal = logica.ConverteStringParaInt(numeroString);
        ...
        public void ConfereVendas()
        {
            var produtosString =
                @"Vendedor Gustavo
                    C�digo Produto	quantidade    valor total          Data venda
            ...
            Assert.That(vendaProdutoAAF1015.Vendedor, Is.EqualTo(vendedorEsperado), $"O vendendedor esperado � {vendedorEsperado}");
            Assert.That(vendaProdutoAAF1015.Valor, Is.EqualTo(valorEsperado), $"O valor esperado � {valorEsperado}");
            Assert.That(vendaProdutoAAF1015.Quantidade, Is.EqualTo(quantidadeEsperada), $"A quantidade esperado � {quantidadeEsperada}");
            Assert.That(vendaProdutoAAF1015.Data, Is.EqualTo(dataEsperada), $"A quantidade esperado � {dataEsperada}");
        }
    }
}